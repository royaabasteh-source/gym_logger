...
export const INITIAL_TEMPLATES = [
  ...
  },
  {
    ...
    entries: [
      ...
      { movementName: 'Pull-Up', reps: 10, weight: 0, unit: 'kg' },
      { movementName: 'Incline Bench Press', reps: 8, weight: 50, unit: 'kg' },
      { movementName: 'Leg Press', reps: 12, weight: 100, unit: 'kg' },
    ]
  },
  {
    name: 'Upper Body',
    order: 2,
    entries: [
      { movementName: 'Dumbbell Bench Press', reps: 10, weight: 24, unit: 'kg' },
